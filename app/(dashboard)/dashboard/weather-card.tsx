      ...
      <div className="bg-gradient-to-br from-green-100 via-white to-green-200 rounded-xl p-6 shadow-lg border border-green-200">
        <div className="flex items-center justify-center min-h-[200px]">
          <div className="text-center">
            ...
            <p className="text-sm text-green-600">Loading weather data...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="bg-gradient-to-br from-green-100 via-white to-green-200 rounded-xl p-6 shadow-lg border border-green-200">
        <div className="flex items-center justify-center min-h-[200px]">
          <div className="text-center">
            ...
            <p className="text-sm text-red-600 mb-2">Unable to load weather</p>
            <button 
    ...
    <div className="bg-gradient-to-br from-green-100 via-white to-green-200 rounded-xl p-6 shadow-lg border border-green-200">
      <div className="flex items-start justify-between mb-6">
        <div>
          <p className="text-xs font-medium text-green-700 mb-1 flex items-center gap-2">
            <Cloud className="inline w-4 h-4 text-green-500" /> WEATHER
          </p>
      ...
      <div className="mb-6 flex items-center gap-8">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-xs text-green-700 mt-2">Humidity</p>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-xs text-green-700 mt-2">Wind</p>

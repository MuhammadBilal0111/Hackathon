  ...
  return (
    <div className="bg-card rounded-xl p-6 shadow-sm border border-border">
      <div className="flex items-start justify-between mb-6">
        <div>
          <p className="text-xs font-medium text-muted-foreground mb-1">PRIMARY CROP</p>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm font-medium text-foreground">Flowering (45 days)</p>
        </div>

        <div>
          <p className="text-xs text-muted-foreground mb-1">Expected Yield</p>
          <p className="text-sm font-medium text-foreground">8.2 tons/hectare</p>
        </div>

  ...
  return (
    <div className="bg-card rounded-2xl p-6 shadow-sm border border-border hover:shadow-md transition-shadow">
      <div className="flex items-start justify-between mb-6">
        <div>
          <p className="text-xs font-semibold text-muted-foreground tracking-wider mb-2">YOUR CROPS</p>
          <h3 className="text-2xl font-bold text-foreground">{crops.length} Active Crops</h3>
        </div>
        ...
        {crops.map((crop, i) => (
          ...
          >
            <div className="flex items-start justify-between mb-3">
              ...
              <span className="text-sm font-bold text-accent">{crop.health}%</span>
            </div>
      ...
      <div className="mt-4 pt-4 border-t border-border/50 flex items-center gap-2">
        ...
        <p className="text-xs text-muted-foreground">
          Overall farm health: <span className="font-semibold text-accent">85%</span>
        </p>
      </div>
    </div>
  )
